...
public abstract class UniversalGossipVillagerMixin extends AbstractTraderEntity {

    public UniversalGossipVillagerMixin(EntityType<? extends AbstractTraderEntity> entityType, World world) {
